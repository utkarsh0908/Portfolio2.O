...
const projects = () => {
  ...
  return (
    ...
    >
      <div className="h-[6px] w-[64px] bg-[#FFFF00]  pt-2 mt-24 rounded-md" data-aos="fade-right" data-aos-duration="100"></div>
      <div className="text-white font-semibold opacity-[.95] text-3xl md:text-6xl"  data-aos="fade-right">Projects</div>

      <div>
        {project.map((item)=>( 
          <div className='text-white flex flex-col md:flex-row mt-20  mb-20 md:mb-40'>
