...
const contact = () => {
  return (
    <div id="contact" className='flex min-h-screen flex-col py-2 font-Noto items-center justify-center'>
      ...
      <button onClick={() => window.location = `mailto: ${details.email}`} className="duration-500 mt-10 mr-4 bg-transparent hover:bg-secondaryHover  hover:text-main py-2 px-8 border border-secondary hover:border-transparent rounded font-Space font-semibold" data-aos="fade-up" data-aos-delay="300">Email</button>
      </div>
  )
}
